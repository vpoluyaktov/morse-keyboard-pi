...
class DotDash:
	...
	def __init__(self):
		...
		self.dash_duration = 0.75
		self.dot_duration = 0.25   # in seconds, may be float
		self.f = 700.0		# sine frequency, Hz, may be float
...
class Morse:
	...
	def transmit(self):
		...
		for i in self.morse:
			...
			time.sleep(.25) #wait a fifth of a second between each command
